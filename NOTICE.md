...
long as the copyright notice and permission notice are preserved in copies or
...
For research, papers, talks, public benchmarks, or published examples, use the
citation metadata in `CITATION.cff` when possible.
