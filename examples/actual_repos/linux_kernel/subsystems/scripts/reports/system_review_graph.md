# srg-linux-paths / scripts Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for scripts in /private/tmp/srg-linux-paths.
...
| Artifacts | 4 | Inspectable files, APIs, tables, dashboards, reports, or outputs. | Use this to trace where system claims can be inspected. |
...
| bpf_doc.py, checkkconfigsymbols.py, clang-tools/, crypto/, gdb/, gen-crc-consts.py, generate_rust_analyzer.py, kconfig/, macro_checker.py, make_fit.py, rust_is_available_test.py, spdxcheck.py | source_surface | unknown | safe_to_share | Detected Python source and build surfaces. |
| asn1_compiler.c, basic/, dtc/, dummy-tools/, elf-parse.c, elf-parse.h, gcc-plugins/, gen_packed_field_checks.c, gendwarfksyms/, genksyms/, include/, insert-sys-cert.c | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| generate_rust_target.rs, rustdoc_test_builder.rs, rustdoc_test_gen.rs | source_surface | unknown | safe_to_share | Detected Rust source and build surfaces. |
| Makefile, genksyms/Makefile, gdb/Makefile, livepatch/Makefile, gendwarfksyms/Makefile, kconfig/Makefile, basic/Makefile, dtc/Makefile, gcc-plugins/Makefile, ipe/Makefile, selinux/Makefile, mod/Makefile, selinux/mdp/Makefile, ipe/polgen/Makefile, gdb/linux/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
