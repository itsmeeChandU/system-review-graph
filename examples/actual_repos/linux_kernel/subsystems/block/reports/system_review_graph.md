# srg-linux-paths / block Subsystem System Review Graph

Generated: `2026-06-08T20:57:40+00:00`
Scope: Generated starter subsystem map for block in /private/tmp/srg-linux-paths.
...
| badblocks.c, bdev.c, bfq-cgroup.c, bfq-iosched.c, bfq-iosched.h, bfq-wf2q.c, bio-integrity-auto.c, bio-integrity-fs.c, bio-integrity.c, bio.c, blk-cgroup-fc-appid.c, blk-cgroup-rwstat.c | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| Makefile, partitions/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
