# srg-linux-paths / LICENSES Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for LICENSES in /private/tmp/srg-linux-paths.
...
|---|---:|---|---|
| Systems | 0 | Bounded contexts, services, subsystems, or product surfaces. | Use this to see whether the report maps the main operating areas. |
| Artifacts | 0 | Inspectable files, APIs, tables, dashboards, reports, or outputs. | Use this to trace where system claims can be inspected. |
...
| Workflows | 0 | Lifecycle steps from input to output. | Use this to follow what happens end to end. |
| Graph edges | 0 | Explicit and derived relationships between manifest nodes. | Use this to audit connectivity and missing relationships. |
...
| Workflow missing | whole report | open | No lifecycle workflow was declared. | Add the input -> transform -> gate -> output path. |
...
```mermaid
flowchart LR
  empty["No workflow steps declared"]
```
