# srg-linux-paths / samples Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for samples in /private/tmp/srg-linux-paths.
...
| Artifacts | 3 | Inspectable files, APIs, tables, dashboards, reports, or outputs. | Use this to trace where system claims can be inspected. |
...
| acrn/, auxdisplay/, binderfs/, bpf/, cgroup/, check-exec/, configfs/, connector/, coresight/, damon/, fanotify/, fprobe/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| rust/ | source_surface | unknown | safe_to_share | Detected Rust source and build surfaces. |
| Makefile, rpmsg/Makefile, uhid/Makefile, vfs/Makefile, nitro_enclaves/Makefile, landlock/Makefile, hung_task/Makefile, livepatch/Makefile, user_events/Makefile, timers/Makefile, kmemleak/Makefile, watch_queue/Makefile, rust/Makefile, fprobe/Makefile, coresight/Makefile, mei/Makefile, cgroup/Makefile, kprobes/Makefile, hw_breakpoint/Makefile, binderfs/Makefile, kdb/Makefile, watchdog/Makefile, v4l/Makefile, qmi/Makefile, seccomp/Makefile, connector/Makefile, check-exec/Makefile, ftrace/Makefile, fanotify/Makefile, vfio-mdev/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
