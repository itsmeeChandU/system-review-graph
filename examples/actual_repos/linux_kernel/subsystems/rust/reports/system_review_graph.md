# srg-linux-paths / rust Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for rust in /private/tmp/srg-linux-paths.
...
| bindings/, exports.c, helpers/, uapi/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| bindings/, build_error.rs, compiler_builtins.rs, ffi.rs, kernel/, macros/, pin-init/, proc-macro2/, quote/, syn/, uapi/ | source_surface | unknown | safe_to_share | Detected Rust source and build surfaces. |
| Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
