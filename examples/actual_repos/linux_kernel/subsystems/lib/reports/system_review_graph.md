# srg-linux-paths / lib Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for lib in /private/tmp/srg-linux-paths.
...
|---|---:|---|---|
| Systems | 2 | Bounded contexts, services, subsystems, or product surfaces. | Use this to see whether the report maps the main operating areas. |
...
| Graph edges | 12 | Explicit and derived relationships between manifest nodes. | Use this to audit connectivity and missing relationships. |
...
| 842/, alloc_tag.c, argv_split.c, ashldi3.c, ashrdi3.c, asn1_decoder.c, asn1_encoder.c, assoc_array.c, atomic64.c, atomic64_test.c, audit.c, base64.c | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| find_bit_benchmark_rust.rs | source_surface | unknown | safe_to_share | Detected Rust source and build surfaces. |
| tests/ | tests | unknown | safe_to_share | Detected test directories that may prove behavior. |
| Makefile, raid6/Makefile, zlib_deflate/Makefile, crypto/Makefile, test_fortify/Makefile, 842/Makefile, vdso/Makefile, dim/Makefile, kunit/Makefile, zlib_dfltcc/Makefile, crc/Makefile, tests/Makefile, lz4/Makefile, xz/Makefile, math/Makefile, zstd/Makefile, raid/Makefile, zlib_inflate/Makefile, fonts/Makefile, pldmfw/Makefile, lzo/Makefile, reed_solomon/Makefile, raid/xor/Makefile, raid/xor/tests/Makefile, math/tests/Makefile, tests/module/Makefile, crc/tests/Makefile, crypto/mpi/Makefile, crypto/tests/Makefile, raid6/test/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
