# srg-linux-paths / fs Subsystem System Review Graph

Generated: `2026-06-08T20:57:40+00:00`
Scope: Generated starter subsystem map for fs in /private/tmp/srg-linux-paths.
...
| 9p/, adfs/, affs/, afs/, aio.c, anon_inodes.c, attr.c, autofs/, backing-file.c, bad_inode.c, befs/, bfs/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| tests/ | tests | unknown | safe_to_share | Detected test directories that may prove behavior. |
| Makefile, xfs/Makefile, proc/Makefile, btrfs/Makefile, orangefs/Makefile, 9p/Makefile, verity/Makefile, omfs/Makefile, hpfs/Makefile, notify/Makefile, autofs/Makefile, devpts/Makefile, adfs/Makefile, crypto/Makefile, openpromfs/Makefile, erofs/Makefile, squashfs/Makefile, jfs/Makefile, qnx6/Makefile, nfsd/Makefile, befs/Makefile, nfs/Makefile, unicode/Makefile, ubifs/Makefile, nls/Makefile, ceph/Makefile, f2fs/Makefile, ufs/Makefile, sysfs/Makefile, fuse/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
