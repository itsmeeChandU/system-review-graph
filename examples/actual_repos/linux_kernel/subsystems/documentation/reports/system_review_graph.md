# srg-linux-paths / Documentation Subsystem System Review Graph

Generated: `2026-06-08T20:57:40+00:00`
Scope: Generated starter subsystem map for Documentation in /private/tmp/srg-linux-paths.
...
| conf.py, sphinx/ | source_surface | unknown | safe_to_share | Detected Python source and build surfaces. |
| scheduler/, usb/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| Makefile, devicetree/bindings/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
