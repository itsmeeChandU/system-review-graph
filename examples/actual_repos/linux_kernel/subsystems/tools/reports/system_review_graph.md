# srg-linux-paths / tools Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for tools in /private/tmp/srg-linux-paths.
...
|---|---:|---|---|
| Systems | 3 | Bounded contexts, services, subsystems, or product surfaces. | Use this to see whether the report maps the main operating areas. |
| Artifacts | 5 | Inspectable files, APIs, tables, dashboards, reports, or outputs. | Use this to trace where system claims can be inspected. |
...
| Graph edges | 15 | Explicit and derived relationships between manifest nodes. | Use this to audit connectivity and missing relationships. |
...
| cgroup/, docs/, lib/, mm/, perf/, rcu/, sched/, sched_ext/, testing/, unittests/, usb/, verification/ | source_surface | unknown | safe_to_share | Detected Python source and build surfaces. |
| accounting/, arch/, bootconfig/, bpf/, counter/, dma/, firewire/, firmware/, gpio/, hv/, iio/, laptop/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| perf/ | source_surface | unknown | safe_to_share | Detected Rust source and build surfaces. |
| docs/ | docs | unknown | safe_to_share | Detected documentation directories that may explain system behavior. |
| Makefile, accounting/Makefile, tracing/Makefile, firmware/Makefile, virtio/Makefile, hv/Makefile, wmi/Makefile, firewire/Makefile, debugging/Makefile, leds/Makefile, usb/Makefile, spi/Makefile, mm/Makefile, pcmcia/Makefile, dma/Makefile, bootconfig/Makefile, counter/Makefile, perf/Makefile, bpf/Makefile, iio/Makefile, gpio/Makefile, objtool/Makefile, sched_ext/Makefile, bpf/resolve_btfids/Makefile, bpf/bpftool/Makefile, bpf/bpftool/Documentation/Makefile, perf/Documentation/Makefile, perf/arch/powerpc/Makefile, perf/arch/s390/Makefile, perf/arch/loongarch/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
...
| System truth boundary | Python Surface | review | Detected from repository files; runtime behavior is not proven. | Inspect this boundary before making stronger behavior claims. |
...
| System truth boundary | Rust Surface | review | Detected from repository files; runtime behavior is not proven. | Inspect this boundary before making stronger behavior claims. |
...
|---|---|---|---|---|---|---|
| Python Surface | unknown | Python | detected source surface | source files -> build/test docs -> inferred system role | Detected from repository files; runtime behavior is not proven. | Replace this starter node with exact subsystem ownership and workflows. |
...
| Rust Surface | unknown | Rust | detected source surface | source files -> build/test docs -> inferred system role | Detected from repository files; runtime behavior is not proven. | Replace this starter node with exact subsystem ownership and workflows. |
