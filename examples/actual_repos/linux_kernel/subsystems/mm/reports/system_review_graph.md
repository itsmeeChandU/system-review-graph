# srg-linux-paths / mm Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for mm in /private/tmp/srg-linux-paths.
...
| backing-dev.c, balloon.c, bootmem_info.c, bpf_memcontrol.c, cma.c, cma.h, cma_debug.c, cma_sysfs.c, compaction.c, damon/, debug.c, debug_page_alloc.c | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| kasan/ | source_surface | unknown | safe_to_share | Detected Rust source and build surfaces. |
| tests/ | tests | unknown | safe_to_share | Detected test directories that may prove behavior. |
| Makefile, kfence/Makefile, kmsan/Makefile, kasan/Makefile, damon/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
