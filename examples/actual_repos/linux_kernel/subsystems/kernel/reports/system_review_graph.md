# srg-linux-paths / kernel Subsystem System Review Graph

Generated: `2026-06-08T20:57:41+00:00`
Scope: Generated starter subsystem map for kernel in /private/tmp/srg-linux-paths.
...
| acct.c, async.c, audit.c, audit.h, audit_fsnotify.c, audit_tree.c, audit_watch.c, auditfilter.c, auditsc.c, backtracetest.c, bounds.c, bpf/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| Makefile, gcov/Makefile, power/Makefile, kcsan/Makefile, futex/Makefile, trace/Makefile, livepatch/Makefile, entry/Makefile, module/Makefile, irq/Makefile, locking/Makefile, sched/Makefile, cgroup/Makefile, time/Makefile, rcu/Makefile, unwind/Makefile, dma/Makefile, events/Makefile, printk/Makefile, liveupdate/Makefile, bpf/Makefile, debug/Makefile, debug/kdb/Makefile, bpf/preload/Makefile, bpf/preload/iterators/Makefile, trace/rv/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
