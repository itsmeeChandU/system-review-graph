...
| apparmor/, bpf/, commoncap.c, commoncap_test.c, device_cgroup.c, inode.c, integrity/, ipe/, keys/, landlock/, loadpin/, lockdown/ | source_surface | unknown | safe_to_share | Detected C / C++ source and build surfaces. |
| Makefile, safesetid/Makefile, landlock/Makefile, yama/Makefile, apparmor/Makefile, tomoyo/Makefile, loadpin/Makefile, lockdown/Makefile, ipe/Makefile, integrity/Makefile, keys/Makefile, bpf/Makefile, selinux/Makefile, smack/Makefile, keys/encrypted-keys/Makefile, keys/trusted-keys/Makefile, integrity/ima/Makefile, integrity/evm/Makefile | config | unknown | safe_to_share | Detected build, package, container, or configuration files. |
